...
$(document).ready(() => {
  $(window).scroll(() => {
    if ($(this).scrollTop() > 850) {
      ...
      $(".progress5").animate({ width: "90%" }, 2000);
      $(".hib").animate({ width: "90%" }, 2000);
      $(".progress6").animate({ width: "10%" }, 2000);
      $(".mav").animate({ width: "10%" }, 2000);
      $(".progress7").animate({ width: "90%" }, 2000);
      $(".html").animate({ width: "90%" }, 2000);
      $(".progress8").animate({ width: "80%" }, 2000);
      $(".javas").animate({ width: "80%" }, 2000);
      $(".progress9").animate({ width: "60%" }, 2000);
      ...
      $(".progress12").animate({ width: "60%" }, 2000);
      $(".nomy").animate({ width: "60%" }, 2000);
    }
  });
});
